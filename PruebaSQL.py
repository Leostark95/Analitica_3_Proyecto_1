...
rutas = ['my_database.db', 'processed_data_2015.csv', 'processed_data_2016.csv']
...
funciones.ejecutar_sql('b_Preprocesamiento.sql', cur)

# Exportar las tablas creadas
funciones.exportar_tabla('processed_data_2016', conn)
funciones.exportar_tabla('processed_data_2015', conn)
